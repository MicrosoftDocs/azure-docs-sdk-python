---
title: Azure Storage Queue client library for Python
keywords: Azure, python, SDK, API, azure-storage-queue, azure-storage-queue
author: maggiepint
ms.author: magpint
ms.date: 06/12/2020
ms.topic: article
...
ms.technology: azure
ms.devlang: python
ms.service: azure-storage-queue
---
...
# Azure Storage Queue client library for Python - Version 12.1.2 
 Samples
