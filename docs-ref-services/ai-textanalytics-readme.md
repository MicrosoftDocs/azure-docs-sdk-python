...
keywords: Azure, python, SDK, API, azure-ai-textanalytics, 
author: maggiepint
ms.author: magpint
ms.date: 07/27/2020
ms.topic: article
...
# Samples for Azure Text Analytics client library for Python - Version 5.0.0 
...
1. Install the Azure Text Analytics client library for Python - Version 5.0.0 
 with [pip][pip]:
