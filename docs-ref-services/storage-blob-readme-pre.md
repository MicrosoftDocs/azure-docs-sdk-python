...
# Azure Storage Blobs client library for Python - Version 12.4.0b1 
...
### Install the package
Install the Azure Storage Blobs client library for Python - Version 12.4.0b1 
...
### Create the client
The Azure Storage Blobs client library for Python - Version 12.4.0b1 
