...
keywords: Azure, python, SDK, API, azure-ai-formrecognizer, azure-ai-formrecognizer
author: maggiepint
ms.author: magpint
ms.date: 06/10/2020
ms.topic: article
...
ms.technology: azure
ms.devlang: python
ms.service: azure-ai-formrecognizer
---
...
# Samples for Azure Form Recognizer client library for Python - Version 1.0.0b3 
...
1. Install the Azure Form Recognizer client library for Python - Version 1.0.0b3 
 with [pip][pip]:
