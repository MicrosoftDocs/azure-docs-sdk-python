...
See [more code samples](https://docs.microsoft.com/en-us/samples/azure/azure-sdk-for-python/storage-blob-samples/) for the Azure Storage Blob client library.
