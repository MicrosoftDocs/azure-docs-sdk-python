...
keywords: Azure, python, SDK, API, azure-storage-file-share, azure-storage-file-share
author: maggiepint
ms.author: magpint
ms.date: 06/12/2020
ms.topic: article
...
ms.technology: azure
ms.devlang: python
ms.service: azure-storage-file-share
---
...
# Azure Storage File Share client library for Python - Version 12.1.2 
 Samples
...
1. Install the Azure Storage File Share client library for Python - Version 12.1.2 
