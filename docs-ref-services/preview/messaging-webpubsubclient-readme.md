...
---
# Azure Web PubSub client library for Python - version 1.1.1a20241218001 
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-python/blob/azure-messaging-webpubsubclient_1.1.1a20241218001/CONTRIBUTING.md) to learn more about how to build and test the code.
