...
---
# Azure AI Agent Server Activity client library for Python - version 1.0.0b3 
...
See the [samples directory](https://github.com/Azure/azure-sdk-for-python/tree/azure-ai-agentserver-activity_1.0.0b3/sdk/agentserver/azure-ai-agentserver-activity/samples) for runnable scenarios, ordered as a learning path:
