...
---
# Azure Service Bus client library for Python - version 7.14.0a20250210001 
...
[Source code](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/)
| [Package (PyPi)][pypi]
| [Package (Conda)](https://anaconda.org/microsoft/azure-servicebus)
| [API reference documentation][api_docs]
| [Product documentation][product_docs]
| [Samples](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples)
| [Changelog](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/CHANGELOG.md)
...
* [ServiceBusSender][sender_reference]: To send messages to a Queue or Topic, one would use the corresponding `get_queue_sender` or `get_topic_sender` method off of a `ServiceBusClient` instance as seen [here](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples/sync_samples/send_queue.py).

* [ServiceBusReceiver][receiver_reference]: To receive messages from a Queue or Subscription, one would use the corresponding `get_queue_receiver` or `get_subscription_receiver` method off of a `ServiceBusClient` instance as seen [here](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples/sync_samples/receive_queue.py).
...
Please find further examples in the [samples](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples) directory demonstrating common Service Bus scenarios such as sending, receiving, session management and message handling.
...
> For more detail on scheduling and schedule cancellation please see a sample [here](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples/sync_samples/schedule_messages_and_cancellation.py).
...
Transfer the message from the primary queue into a special "dead-letter sub-queue" where it can be accessed using the `ServiceBusClient.get_<queue|subscription>_receiver` function with parameter `sub_queue=ServiceBusSubQueue.DEAD_LETTER` and consumed from like any other receiver. (see sample [here](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples/sync_samples/receive_deadlettered_messages.py))
...
by setting it aside such that it must be received by sequence number in a call to `ServiceBusReceiver.receive_deferred_messages` (see sample [here](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples/sync_samples/receive_deferred_message_queue.py))
...
[here](https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-mgmt-servicebus/tests) as well.
...
[servicebus_management_repository]: https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-mgmt-servicebus
...
[token_credential_interface]: https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/core/azure-core/azure/core/credentials.py
...
[sample_authenticate_client_connstr]: https://github.com/Azure/azure-sdk-for-python/blob/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples/sync_samples/authenticate_client_connstr.py
[sample_authenticate_client_aad]: https://github.com/Azure/azure-sdk-for-python/blob/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/samples/sync_samples/client_identity_authentication.py
[migration_guide]: https://github.com/Azure/azure-sdk-for-python/tree/azure-servicebus_7.14.0a20250210001/sdk/servicebus/azure-servicebus/migration_guide.md
