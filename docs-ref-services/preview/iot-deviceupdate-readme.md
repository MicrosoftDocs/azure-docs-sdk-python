...
keywords: Azure, python, SDK, API, azure-iot-deviceupdate, 
author: ramya-rao-a
ms.author: ramyar
ms.date: 03/04/2021
ms.topic: reference
...
# Azure Device Update for IoT Hub client library for Python - Version 1.0.0b1 


The library provides access to the Device Update for IoT Hub service that enables customers to publish updates for their IoT devices to the cloud, and then deploy these updates to their devices (approve updates to groups of devices managed and provisioned in IoT Hub).

[Source code](https://github.com/Azure/azure-sdk-for-python/tree/azure-iot-deviceupdate_1.0.0b1/sdk/deviceupdate/azure-iot-deviceupdate) | [Package (PyPI)](https://aka.ms/azsdk/python/deviceupdate-pypi) | [Product documentation](https://docs.microsoft.com/azure/iot-hub-device-update/understand-device-update)
...
You can familiarize yourself with different APIs using [Samples](https://github.com/Azure/azure-sdk-for-python/tree/azure-iot-deviceupdate_1.0.0b1/sdk/deviceupdate/azure-iot-deviceupdate/samples).
...
Get started with our [Device Update for IoT Hub samples](https://github.com/Azure/azure-sdk-for-python/tree/azure-iot-deviceupdate_1.0.0b1/sdk/deviceupdate/azure-iot-deviceupdate/samples)
...
<!-- LINKS -->
[azure_core]: https://github.com/Azure/azure-sdk-for-python/blob/azure-iot-deviceupdate_1.0.0b1/sdk/core/azure-core/README.md
