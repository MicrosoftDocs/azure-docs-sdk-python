---
title: Azure Video Analyzer Edge for IoT Edge client library for Python
keywords: Azure, python, SDK, API, azure-media-videoanalyzer-edge, 
author: maggiepint
ms.author: magpint
ms.date: 05/19/2021
ms.topic: article
...
# Azure Video Analyzer Edge for IoT Edge client library for Python - Version 1.0.0b1 
...
[source]: https://github.com/Azure/azure-sdk-for-python/tree/azure-media-videoanalyzer-edge_1.0.0b1/sdk/videoanalyzer
