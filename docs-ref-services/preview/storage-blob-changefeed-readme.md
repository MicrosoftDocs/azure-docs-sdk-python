...
ms.service: storage
---
# Azure Storage Blob ChangeFeed client library for Python - version 12.0.0a20250210002 
...
3. Use a token credential from [azure.identity](https://github.com/Azure/azure-sdk-for-python/tree/azure-storage-blob-changefeed_12.0.0a20250210002/sdk/identity/azure-identity)
...
Get started with our [Azure Blob ChangeFeed samples](https://github.com/Azure/azure-sdk-for-python/tree/azure-storage-blob-changefeed_12.0.0a20250210002/sdk/storage/azure-storage-blob-changefeed/samples).
...
* [change_feed_samples.py](https://github.com/Azure/azure-sdk-for-python/tree/azure-storage-blob-changefeed_12.0.0a20250210002/sdk/storage/azure-storage-blob-changefeed/samples/change_feed_samples.py) - Examples for authenticating and operating on the client:
    * list events by page
    * list all events
