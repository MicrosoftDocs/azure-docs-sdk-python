...
---
# Azure Communication Email client library for Python - version 1.0.1a20250113001 
...
Email operations will throw an exception if the request to the server fails. The Email client will raise exceptions defined in [Azure Core](https://github.com/Azure/azure-sdk-for-python/blob/azure-communication-email_1.0.1a20250113001/sdk/core/azure-core/README.md).
