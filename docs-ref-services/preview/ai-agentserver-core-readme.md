...
---
# Azure AI Agent Server Core client library for Python - version 2.0.0b4 
...
- See the [container image spec](https://github.com/Azure/azure-sdk-for-python/tree/azure-ai-agentserver-core_2.0.0b4/sdk/agentserver) for the full hosted agent contract.
