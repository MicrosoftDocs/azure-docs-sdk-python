---
title: Azure AI Language Documents client library for Python
keywords: Azure, python, SDK, API, azure-ai-language-documents, cognitivelanguage
ms.date: 08/19/2026
ms.topic: reference
ms.devlang: python
ms.service: cognitivelanguage
---
# Azure AI Language Documents client library for Python - version 1.0.0a20260819001 
