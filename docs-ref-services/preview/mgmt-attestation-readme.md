...
# Microsoft Azure attestation SDK for Python

This is the Microsoft Azure attestation Management Client Library.
This package has been tested with Python 2.7, 3.5, 3.6, 3.7 and 3.8.
For a more complete view of Azure libraries, see the [azure attestation sdk python release](https://aka.ms/azsdk/python/all).
