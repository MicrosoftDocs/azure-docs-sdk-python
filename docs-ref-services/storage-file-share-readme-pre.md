...
# Azure Storage File Share client library for Python - Version 12.2.0b1 
...
### Install the package
Install the Azure Storage File Share client library for Python - Version 12.2.0b1 
...
### Create the client
The Azure Storage File Share client library for Python - Version 12.2.0b1 
