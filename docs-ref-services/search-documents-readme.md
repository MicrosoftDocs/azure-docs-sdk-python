...
keywords: Azure, Python, SDK, API, search, azure-search-documents
author: maggiepint
ms.author: magpint
ms.date: 04/16/2020
ms.topic: article
...
ms.service: search
---
 # Azure Cognitive Search client library for Python - Version 1.0.0b2 
...
[Samples](https://github.com/Azure/azure-sdk-for-python/tree/b435d47875bf8dba8af64cc2762014bd77b48943/sdk/search/azure-search-documents/samples)
...
Install the Azure Cognitive Search client library for Python - Version 1.0.0b2 
