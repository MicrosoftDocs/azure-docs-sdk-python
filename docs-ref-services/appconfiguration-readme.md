...
keywords: Azure, Python, SDK, API, appconfiguration, azure-appconfiguration
author: maggiepint
ms.author: magpint
ms.date: 04/16/2020
ms.topic: article
...
---
# Azure App Configuration client library for Python - Version 1.0.0 
...
Install the Azure App Configuration client library for Python - Version 1.0.0 
 with pip:
