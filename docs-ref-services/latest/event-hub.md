...
|------------------------------------------|-------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
|    [azure-mgmt-eventhub](https://pypi.org/project/azure-mgmt-eventhub/)    |    [Reference](https://docs.microsoft.com/en-us/python/api/overview/azure/eventhubs/management?view=azure-python)    |   [GitHub](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/eventhub/azure-mgmt-eventhub)    |
