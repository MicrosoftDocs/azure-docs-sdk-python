...
ms.service: monitor
---
# Azure Monitor Query client library for Python - version 2.0.0 
...
A full sample can be found [here](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_logs_single_query.py).
...
A full sample can be found [here](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_batch_query.py).
...
A full sample can be found [here](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_log_query_multiple_workspaces.py).
...
Interpretation of the visualization data is left to the library consumer. To use this data with the [Plotly graphing library](https://plotly.com/python/), see the [synchronous](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_logs_query_visualization.py) or [asynchronous](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/async_samples/sample_logs_query_visualization_async.py) code samples.
...
- [Send a single query with LogsQueryClient and handle the response as a table](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_logs_single_query.py) ([async sample](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/async_samples/sample_log_query_async.py))
- [Send a single query with LogsQueryClient and handle the response in key-value form](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_logs_query_key_value_form.py)
- [Send a single query with LogsQueryClient without pandas](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_single_log_query_without_pandas.py)
- [Send a single query with LogsQueryClient across multiple workspaces](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_log_query_multiple_workspaces.py)
- [Send multiple queries with LogsQueryClient](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_batch_query.py)
- [Send a single query with LogsQueryClient using server timeout](https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples/sample_server_timeout.py)
...
[changelog]: https://github.com/Azure/azure-sdk-for-python/tree/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/CHANGELOG.md
...
[samples]: https://github.com/Azure/azure-sdk-for-python/tree/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/samples
[source]: https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/
[troubleshooting_guide]: https://github.com/Azure/azure-sdk-for-python/blob/azure-monitor-query_2.0.0/sdk/monitor/azure-monitor-query/TROUBLESHOOTING.md
