...
> [Explore the Client APIs](/python/api/azure-batch/?view=azure-python)
...
> [!div class="nextstepaction"]
> [Explore the Management APIs](/python/api/overview/azure/mgmt-batch-readme?view=azure-python)